...
- **Simulated exposure profile (PFE/EPE)**: Monte Carlo simulation (driftless geometric Brownian motion) of exposure over time, EPE and PFE per time step, effective EPE, and an IMM-style exposure at default (`alpha x effective EPE`).
